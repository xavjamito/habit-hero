...
import { getWeekDays, formatWeekDay, formatDayNumber, isDateInArray } from "@/lib/utils";
...
export default function WeekOverview({ completions, habits }: WeekOverviewProps) {
      ...
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2 items-center">
            ...
            <span className="text-sm font-medium py-1">{weekStart} - {weekEnd}</span>
            <Button 
              variant="ghost" 
              size="icon"
              onClick={nextWeek}
        ...
        {weekDays.map((day, index) => {
          ...
          return (
            ...
            >
              ...
              <span className={`mt-1 font-semibold ${isSelected ? "text-primary" : "text-foreground"}`}>
                {formatDayNumber(day)}
              </span>
